...
*This resequences the exact same backlog from `build_steps.md` — no
...
not a pile of half-wired endpoints and unstyled screens.*

*The package/tool choices from `build_steps.md`'s "Packages & Tools"
section are unchanged and not repeated here — this doc is purely about
sequencing.*

*Sprint length isn't specified — use whatever cadence your team
...
usable if stalled" property this whole plan exists to guarantee.*
